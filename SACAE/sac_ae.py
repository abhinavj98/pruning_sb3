    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                next_actions, next_log_prob, next_features = self.actor.action_log_prob(replay_data.next_observations)
            ...
            ae_l2_loss = self.mse_loss(F.interpolate(replay_data.observations['depth'], size = (112,112)), features[1]) 
            ...
            actor_loss = (ent_coef * log_prob - min_qf_pi).mean() + ae_l2_loss*0.2
        ...
        with th.no_grad():
            _, recon = self.policy.actor.extract_features(plot_img, self.policy.actor.features_extractor)
