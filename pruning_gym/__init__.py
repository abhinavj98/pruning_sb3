...
UR5_URDF_PATH = os.path.join(MESHES_AND_URDF_PATH, 'urdf', 'ur5e', 'ur5e_cutter_new_calibrated_precise_level.urdf')
PANDA_URDF_PATH = os.path.join(MESHES_AND_URDF_PATH, 'urdf', 'panda', 'panda_arm_pruner.urdf')
