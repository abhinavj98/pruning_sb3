...
class CustomEvalCallback(EventCallback):
    ...
    def _grab_screen_callback(self, _locals: Dict[str, Any], _globals: Dict[str, Any]) -> None:
        ...
        if episode_counts == 0:
            ...
            screen_copy = cv2.putText(screen_copy, "Reward: " + str(_locals['reward']), (0, 80),
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            if self.best_model_save_path is not None:
                ...
                with open(os.path.join(self.best_model_save_path, "current_mean_std.pkl"), "wb") as f:
                    pickle.dump(
                        (self.model.policy.running_mean_var_oflow_x, self.model.policy.running_mean_var_oflow_y), f)
            ...
            self.episode_counter = 0
            # reset current index
            self.current_index = [self.n_eval_episodes // self.eval_env.num_envs * i for i in
